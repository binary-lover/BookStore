            ...
            <div className={`${sticky ? 'sticky-navbar shadow-md bg-base-200 dark:bg-slate-800 dark:text-white duration-200 transition-all ease-in-out' : ''}
                ...
                <div className="navbar p-0">
                    <div className="navbar-start">
                        ...
                        <a href='/home' className=" text-3xl font-bold cursor-pointer"><span className='text-pink-500'>B</span>ook<span className='text-pink-500'>S</span>hell</a>
                    </div>
                    <div className="navbar-end space-x-3">
                        ...
                        <div className="hidden md:block ">
                            <label className="input input-bordered px-3 py-1 flex items-center gap-2 dark:bg-slate-900 dark:text-white border-slate-500">
