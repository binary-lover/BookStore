...
function Banner() {
    return (
        <>
            ...
            <div className="max-w-screen-2x1 container mx-auto md:px-20 px-4 flex flex-col md:flex-row mt-16 md:mt-32">
                ...
                <div className="order-2 md:order-1 w-full md:w-1/2 mt-12  ">
                    ...
                    <label className=" md:mr-10 input input-bordered flex items-center gap-2">
